...
export async function Announcement() {
    ...
    return (
        <>
            ...
            <div className="mx-auto mb-14 flex max-w-5xl flex-col items-center justify-center gap-3 rounded-2xl border border-brand/10 bg-mint/90 px-5 py-4 text-sm shadow-[0_16px_30px_rgba(12,16,36,0.06)] sm:flex-row sm:gap-4 sm:px-6 sm:py-4 sm:text-base">
